...
export const translations = {
  en: {
      ...
      timeline: [
        {
          year: "2017",
          title: "BNB Launch",
          description: "BNB was launched in July 2017 as an ERC-20 token on Ethereum, raising $15 million in its initial coin offering.",
        },
        {
          year: "2019",
          title: "Native Chain",
          description: "BNB migrated to its native blockchain, marking a major milestone in decentralization.",
        },
        {
          year: "2020",
          title: "BSC Launch",
          description: "BNB Smart Chain (BSC) launched, enabling smart contracts and DeFi applications with low fees.",
        },
        {
          year: "2022",
          title: "BNB Chain Evolution",
          description: "BNB ecosystem evolved into BNB Chain, focusing on MetaFi and broader ecosystem development.",
        },
        {
          year: "2024",
    ...
    footer: {
      ...
      support: "Support",
      copyright: "© 2026 BNB Rewards. All rights reserved.",
  ...
  zh: {
      ...
      timeline: [
        {
          year: "2017",
          title: "BNB诞生",
          description: "2017年7月，BNB作为ERC-20代币在以太坊上发布，通过首次代币发行筹集了1500万美元。",
        },
        {
          year: "2019",
          title: "原生链上线",
          description: "BNB迁移到其原生区块链，标志着去中心化的重大里程碑。",
        },
        {
          year: "2020",
          title: "BSC发布",
          description: "BNB智能链（BSC）上线，支持智能合约和低费用的DeFi应用。",
        },
        {
          year: "2022",
          title: "BNB Chain演进",
          description: "BNB生态系统演进为BNB Chain，专注于MetaFi和更广泛的生态系统发展。",
        },
        {
          year: "2024",
          title: "生态增长",
    ...
    faq: {
      ...
      items: [
        ...
        {
          question: "支持哪些钱包？",
          answer: "我们支持主流Web3钱包，包括MetaMask、Trust Wallet和WalletConnect兼容钱包。请确保已连接到BNB智能链网络。",
        },
        {
    ...
    footer: {
      ...
      privacy: "隐私政策",
      support: "支持",
      copyright: "© 2026 BNB Rewards. 保留所有权利。",
  ...
  ja: {
      ...
      timeline: [
        {
          year: "2017",
          title: "BNB誕生",
          description: "2017年7月、BNBはERC-20トークンとしてイーサリアム上でローンチ、初期コインオファリングで1500万ドルを調達。",
        },
        {
          year: "2019",
          title: "ネイティブチェーン",
          description: "BNBが独自ブロックチェーンに移行、分散化の大きなマイルストーン。",
        },
        {
          year: "2020",
          title: "BSCローンチ",
          description: "BNB Smart Chain（BSC）がローンチ、低手数料でスマートコントラクトとDeFiアプリを実現。",
        },
        {
          year: "2022",
          title: "BNB Chain進化",
          description: "BNBエコシステムがBNB Chainに進化、MetaFiと広範なエコシステム開発に注力。",
        },
        {
          year: "2024",
          title: "エコシステム成長",
    ...
    faq: {
      ...
      items: [
        ...
        {
          question: "対応ウォレットは？",
          answer: "MetaMask、Trust Wallet、WalletConnect対応ウォレットをサポート。BNB Smart Chainネットワークに接続してください。",
        },
        {
      ...
      timeline: [
        {
          year: "2017",
          title: "BNB 출시",
          description: "2017년 7월, BNB는 이더리움에서 ERC-20 토큰으로 출시, 초기 코인 오퍼링으로 1,500만 달러 모금.",
        },
        {
          year: "2019",
          title: "네이티브 체인",
          description: "BNB가 자체 블록체인으로 이전, 탈중앙화의 주요 이정표.",
        },
        {
          year: "2020",
          title: "BSC 출시",
          description: "BNB 스마트 체인(BSC) 출시, 저렴한 수수료로 스마트 컨트랙트와 DeFi 앱 지원.",
        },
        {
          year: "2022",
          title: "BNB Chain 진화",
          description: "BNB 생태계가 BNB Chain으로 진화, MetaFi와 생태계 확장에 집중.",
        },
        {
          year: "2024",
          title: "생태계 성장",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "MetaMask, Trust Wallet, WalletConnect 호환 지갑을 지원합니다. BNB 스마트 체인 네트워크에 연결되어 있는지 확인하세요.",
        },
        {
  ...
  es: {
      ...
      timeline: [
        {
          ...
          description: "BNB se lanzó en julio de 2017 como token ERC-20 en Ethereum en su oferta inicial de monedas, recaudando $15 millones.",
        },
        {
          year: "2019",
          title: "Cadena Nativa",
          description: "BNB migró a su blockchain nativa, marcando un hito importante en descentralización.",
        },
        {
          year: "2020",
          title: "Lanzamiento de BSC",
          description: "BNB Smart Chain (BSC) se lanzó, habilitando contratos inteligentes y aplicaciones DeFi con bajas tarifas.",
        },
        {
          year: "2022",
          title: "Evolución BNB Chain",
          description: "El ecosistema BNB evolucionó a BNB Chain, enfocándose en MetaFi y desarrollo del ecosistema.",
        },
        {
          year: "2024",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "Soportamos billeteras Web3 principales incluyendo MetaMask, Trust Wallet y billeteras compatibles con WalletConnect. Asegúrate de estar conectado a BNB Smart Chain.",
        },
        {
    ...
    footer: {
      ...
      support: "Soporte",
      copyright: "© 2026 BNB Rewards. Todos los derechos reservados.",
  ...
  fr: {
      ...
      timeline: [
        {
          ...
          description: "BNB a été lancé en juillet 2017 comme token ERC-20 sur Ethereum lors de son ICO, levant 15 millions de dollars.",
        },
        {
          year: "2019",
          title: "Chaîne Native",
          description: "BNB a migré vers sa blockchain native, marquant une étape majeure vers la décentralisation.",
        },
        {
          year: "2020",
          title: "Lancement de BSC",
          description: "BNB Smart Chain (BSC) a été lancé, permettant les smart contracts et applications DeFi avec des frais réduits.",
        },
        {
          year: "2022",
          title: "Évolution BNB Chain",
          description: "L'écosystème BNB a évolué en BNB Chain, se concentrant sur MetaFi et le développement de l'écosystème.",
        },
        {
          year: "2024",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "Nous supportons les principaux portefeuilles Web3 : MetaMask, Trust Wallet et portefeuilles compatibles WalletConnect. Assurez-vous d'être connecté au réseau BNB Smart Chain.",
        },
        {
    ...
    footer: {
      ...
      support: "Support",
      copyright: "© 2026 BNB Rewards. Tous droits réservés.",
  ...
  de: {
      ...
      timeline: [
        {
          year: "2017",
          title: "BNB Start",
          description: "BNB wurde im Juli 2017 als ERC-20-Token auf Ethereum während des ICO gestartet und sammelte 15 Millionen Dollar.",
        },
        {
          year: "2019",
          title: "Native Chain",
          description: "BNB migrierte zu seiner nativen Blockchain, ein wichtiger Meilenstein der Dezentralisierung.",
        },
        {
          year: "2020",
          title: "BSC Start",
          description: "BNB Smart Chain (BSC) startete und ermöglichte Smart Contracts und DeFi-Anwendungen mit niedrigen Gebühren.",
        },
        {
          year: "2022",
          title: "BNB Chain Evolution",
          description: "Das BNB-Ökosystem entwickelte sich zu BNB Chain mit Fokus auf MetaFi und Ökosystem-Entwicklung.",
        },
        {
          year: "2024",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "Wir unterstützen große Web3-Wallets: MetaMask, Trust Wallet und WalletConnect-kompatible Wallets. Stellen Sie sicher, dass Sie mit dem BNB Smart Chain Netzwerk verbunden sind.",
        },
        {
    ...
    footer: {
      ...
      support: "Support",
      copyright: "© 2026 BNB Rewards. Alle Rechte vorbehalten.",
  ...
  ru: {
      ...
      timeline: [
        {
          year: "2017",
          title: "Запуск BNB",
          description: "BNB был запущен в июле 2017 как токен ERC-20 на Ethereum во время ICO, собрав $15 миллионов.",
        },
        {
          year: "2019",
          title: "Нативный Чейн",
          description: "BNB мигрировал на собственный блокчейн, важная веха децентрализации.",
        },
        {
          year: "2020",
          title: "Запуск BSC",
          description: "BNB Smart Chain (BSC) запущен, обеспечивая смарт-контракты и DeFi с низкими комиссиями.",
        },
        {
          year: "2022",
          title: "Эволюция BNB Chain",
          description: "Экосистема BNB эволюционировала в BNB Chain с фокусом на MetaFi и развитие экосистемы.",
        },
        {
          year: "2024",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "Мы поддерживаем основные Web3-кошельки: MetaMask, Trust Wallet и совместимые с WalletConnect. Убедитесь, что подключены к сети BNB Smart Chain.",
        },
        {
    ...
    footer: {
      ...
      support: "Поддержка",
      copyright: "© 2026 BNB Rewards. Все права защищены.",
  ...
  pt: {
      ...
      timeline: [
        {
          ...
          description: "BNB foi lançado em julho de 2017 como token ERC-20 no Ethereum durante a ICO, arrecadando $15 milhões.",
        },
        {
          year: "2019",
          title: "Cadeia Nativa",
          description: "BNB migrou para seu blockchain nativo, marcando um marco importante na descentralização.",
        },
        {
          year: "2020",
          title: "Lançamento do BSC",
          description: "BNB Smart Chain (BSC) foi lançada, permitindo contratos inteligentes e aplicações DeFi com taxas baixas.",
        },
        {
          year: "2022",
          title: "Evolução BNB Chain",
          description: "O ecossistema BNB evoluiu para BNB Chain, focando em MetaFi e desenvolvimento do ecossistema.",
        },
        {
          year: "2024",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "Suportamos principais carteiras Web3: MetaMask, Trust Wallet e carteiras compatíveis com WalletConnect. Certifique-se de estar conectado à rede BNB Smart Chain.",
        },
        {
    ...
    footer: {
      ...
      support: "Suporte",
      copyright: "© 2026 BNB Rewards. Todos os direitos reservados.",
  ...
  tr: {
      ...
      timeline: [
        {
          year: "2017",
          title: "BNB Lansmanı",
          description: "BNB, Temmuz 2017'de Ethereum'da ERC-20 token olarak piyasaya sürüldü, ICO'da 15 milyon dolar toplandı.",
        },
        {
          year: "2019",
          title: "Yerel Zincir",
          description: "BNB, kendi blok zincirine geçti, merkeziyetsizlikte önemli bir kilometre taşı.",
        },
        {
          year: "2020",
          title: "BSC Lansmanı",
          description: "BNB Smart Chain (BSC) başlatıldı, düşük ücretlerle akıllı sözleşmeler ve DeFi uygulamaları sundu.",
        },
        {
          year: "2022",
          title: "BNB Chain Evrimi",
          description: "BNB ekosistemi BNB Chain'e evrildi, MetaFi ve ekosistem geliştirmeye odaklandı.",
        },
        {
          year: "2024",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "Başlıca Web3 cüzdanlarını destekliyoruz: MetaMask, Trust Wallet ve WalletConnect uyumlu cüzdanlar. BNB Smart Chain ağına bağlı olduğunuzdan emin olun.",
        },
        {
    ...
    footer: {
      ...
      support: "Destek",
      copyright: "© 2026 BNB Rewards. Tüm hakları saklıdır.",
  ...
  vi: {
      ...
      timeline: [
        {
          year: "2017",
          title: "Ra Mắt BNB",
          description: "BNB được ra mắt vào tháng 7/2017 dưới dạng token ERC-20 trên Ethereum trong ICO, huy động 15 triệu đô la.",
        },
        {
          year: "2019",
          title: "Chuỗi Gốc",
          description: "BNB chuyển sang blockchain riêng, đánh dấu cột mốc quan trọng về phi tập trung.",
        },
        {
          year: "2020",
          title: "Ra Mắt BSC",
          description: "BNB Smart Chain (BSC) ra mắt, cho phép hợp đồng thông minh và ứng dụng DeFi với phí thấp.",
        },
        {
          year: "2022",
          title: "Tiến Hóa BNB Chain",
          description: "Hệ sinh thái BNB tiến hóa thành BNB Chain, tập trung vào MetaFi và phát triển hệ sinh thái.",
        },
        {
          year: "2024",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "Chúng tôi hỗ trợ các ví Web3 chính: MetaMask, Trust Wallet và ví tương thích WalletConnect. Đảm bảo kết nối với mạng BNB Smart Chain.",
        },
        {
    ...
    footer: {
      ...
      support: "Hỗ Trợ",
      copyright: "© 2026 BNB Rewards. Bảo lưu mọi quyền.",
  ...
  ar: {
    ...
    footer: {
      ...
      support: "الدعم",
      copyright: "© 2026 BNB Rewards. جميع الحقوق محفوظة.",
